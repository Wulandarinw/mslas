            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600">ESLAS</span></h1>
    ...
    <div class="bg-orange-200 py-20">
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          dark:focus:ring-gray-600"
                        href="/products?selected_categories[0]={{ $category->category_code }}"
                        wire:key="{{ $category->category_code }}">
    ...
    <div class="bg-gray-100 py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h1 class="text-5xl font-bold text-gray-900">Our <span class="text-blue-500">Products</span></h1>
                ...
                <p class="text-base text-gray-500">
                    Discover our wide range of high-quality products tailored to your needs.
                </p>
            </div>
                    ...
                    <div
                        ...
                        <a href="/products/{{ $product->name }}">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-gray-600 text-sm mb-4">{{ Str::limit($product->desc, 100) }}</p>
                                <div class="flex justify-between items-center">
                                    <span class="text-blue-600 font-bold">
                                        Rp {{ number_format($product->variations->min('price'), 0, ',', '.') }}
                                    </span>
                                </div>
                            </div>
                        </a>
